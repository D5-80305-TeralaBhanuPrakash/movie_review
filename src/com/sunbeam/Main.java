...
public class Main {
	...
	public static void signUp() {
		...
		if (!isValidName(fname)) {
            System.out.println("Invalid first name. It should not contain numeric characters.");
            return;
        }
		System.out.print("Last Name: ");
		String lname = sc.next();
		if (!isValidName(lname)) {
            System.out.println("Invalid last name. It should not contain numeric characters.");
            return;
        }
